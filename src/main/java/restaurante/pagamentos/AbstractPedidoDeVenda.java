...
public abstract class AbstractPedidoDeVenda <Request, Response>{

	final AmbienteCielo environment;
	private final DadosCielo merchant;
	private HttpClient httpClient;

	AbstractPedidoDeVenda(DadosCielo merchant, AmbienteCielo environment) {
	...
	HttpResponse sendRequest(HttpUriRequest request) throws IOException {
		...
		request.addHeader("MerchantId", merchant.getMerchantId());
		request.addHeader("MerchantKey", merchant.getMerchantKey());
