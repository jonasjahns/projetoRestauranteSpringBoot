...
public class Payment {
	...
	private CartaoDeCredito creditCard;
	@SerializedName("Tid")
	private String tid;
	...
	public CartaoDeCredito creditCard(String securityCode, String brand) {
		setType(Type.CreditCard);
		setCreditCard(new CartaoDeCredito(securityCode, brand));
	...
	public CartaoDeCredito getCreditCard() {
		return creditCard;
	}

	public Payment setCreditCard(CartaoDeCredito creditCard) {
