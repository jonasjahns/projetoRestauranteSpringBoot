...
public class RespostaVenda {
	...
	public RespostaVenda() {
    }

	public RespostaVenda(String status, String reasonCode, String reasonMessage, String providerReturnCode, String providerReturnMessage, String returnCode, String returnMessage, Links[] links) {
        this.status = status;
	...
	public String toString() {
		return "RespostaVenda [merchantOrderId=" + merchantOrderId + ", status=" + status + ", reasonCode=" + reasonCode
				+ ", reasonMessage=" + reasonMessage + ", providerReturnCode=" + providerReturnCode
				+ ", providerReturnMessage=" + providerReturnMessage + ", returnCode=" + returnCode + ", returnMessage="
				+ returnMessage + ", authenticationUrl=" + authenticationUrl + ", links=" + Arrays.toString(links)
				+ "]";
	}
